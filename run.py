...
#
# # Load config file
# cfg = OmegaConf.load(os.path.join(os.path.dirname(__file__), r'C:\Users\dimas.perceka\OneDrive - Koltiva\Desktop\Belajar\Deep Learning\zoom_cocoamap\cocoamapping\config.yaml'))
...
if args.data_dir is not None:
    cfg.data.data_dir = args.data_dir  # Update the 'data_dir' field in the configuration

def launch_training():
    print(f'Start training.')
    wandb.init()  # Tambahkan inisialisasi Wandb di sini
    train = Training(config=cfg)
    train.launch_training()
